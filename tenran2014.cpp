...
//一つのゲームの枠の描画
int UI_2014::DrawSpecialBox(int x, int y, int width, int height, int which, int time) {
	switch (which) {
	case 0:
...
int UI_2014::Init(void) {
	...
	MikanDraw->CreateTexture(tnum + 3, "material/cateicon.png");
	...
	MikanSound->SetVolume(3, sys.tenlan->GetMaxVolume());
